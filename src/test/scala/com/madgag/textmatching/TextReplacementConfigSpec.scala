...
class TextReplacementConfigSpec extends AnyFlatSpec with Matchers {
  ...
  it should "apply transforms in the order they occur" in {
    TextReplacementConfig(Seq("awesome", "some"), "***REMOVED***").get.apply("Totally awesome") shouldBe "Totally ***REMOVED***"
    TextReplacementConfig(Seq("some", "awesome"), "***REMOVED***").get.apply("Totally awesome") shouldBe "Totally awe***REMOVED***"
  }
}
